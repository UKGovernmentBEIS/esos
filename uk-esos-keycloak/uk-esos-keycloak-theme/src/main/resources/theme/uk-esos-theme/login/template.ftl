<#macro registrationLayout bodyClass="" displayInfo=true displayProblems=false displayMessage=true displayWide=false displayRequiredFields=false displayResetLinks=false htmlPageTitle="${msg('loginTitle')}">
    <!DOCTYPE html>
    ...
    <header class="govuk-header " role="banner" data-module="govuk-header">
        <div class="govuk-header__container govuk-width-container">
            ...
            <div class="govuk-header__content">
                <a href="${properties.homeUrl}" class="govuk-header__link govuk-header__link--service-name">
    ...
    <div class="govuk-width-container">
        <main class="govuk-main-wrapper " id="main-content" role="main" style="min-height: calc(100vh - 60px - 310px);">
            ...
            <span class="govuk-caption-l"><#nested "headerCaption"></span>
            ...
            <#assign isSystemAction = message?has_content && message.summary?has_content && (message.summary == msg("configureTotpMessage") || message.summary == msg("confirmExecutionOfActions") || message.summary == msg("resetPasswordMessage") || message.summary == msg("accountUpdatedMessage") || message.summary == msg("expiredActionMessage") || message.summary == msg("expiredActionTokenNoSessionMessage"))>
                ...
                <div class="govuk-error-summary" aria-labelledby="error-summary-title" role="alert" tabindex="-1"
                    ...
                    <div class="govuk-error-summary__body">
                        <ul class="govuk-list govuk-error-summary__list">
                            <li>
                                <#if message.summary == msg("invalidUserMessage")><a
                                        href="#username">${kcSanitize(message.summary)?no_esc}</a>
                                <#elseif message.summary == msg("missingTotpMessage") || message.summary == msg("invalidTotpMessage")>
                                    <a href="#otpCode">${kcSanitize(message.summary)?no_esc}</a>
                    ...
                    <ul class="govuk-footer__inline-list">
                        <li class="govuk-footer__inline-list-item">
                            <a class="govuk-footer__link"
                               href="${properties.privacyNoticeUrl}">${msg("privacyNotice")}</a>
                        </li>
                        <li class="govuk-footer__inline-list-item">
                        ...
                        <li class="govuk-footer__inline-list-item">
                            <a class="govuk-footer__link"
                               href="${properties.accessibilityStatementUrl}">${msg("accessibilityStatement")}</a>
                        </li>
                        <li class="govuk-footer__inline-list-item">
                            <a class="govuk-footer__link"
                               ...
                               target="_blank">${msg("legislation")}</a>
                        </li>
                    </ul>
    ...
    <#if properties.bodyScripts?has_content>
        <#list properties.bodyScripts?split(' ') as bodyScript>
            <script
                    src="${url.resourcesPath}/${bodyScript}"
                    <#if bodyScript?starts_with("js/govuk")>
                        type="module"
                    <#else>
    ...
    <script type="module">
        import {
            initAll
        } from '${url.resourcesPath}/${properties.govukFrontendScript}';
        initAll()
    </script>
    </body>
    </html>
