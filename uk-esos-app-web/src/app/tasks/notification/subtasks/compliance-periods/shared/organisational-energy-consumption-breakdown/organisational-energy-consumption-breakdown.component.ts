...
import { organisationalEnergyConsumptionBreakdownFormProvider } from '@tasks/notification/subtasks/compliance-periods/shared/organisational-energy-consumption-breakdown/organisational-energy-consumption-breakdown-form.provider';
...
@Component({
  ...
  templateUrl: './organisational-energy-consumption-breakdown.component.html',
  standalone: true,
  ...
  providers: [organisationalEnergyConsumptionBreakdownFormProvider],
})
export class OrganisationalEnergyConsumptionBreakdownComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.heading = WIZARD_STEP_HEADINGS[WizardStep.ORGANISATIONAL_ENERGY_CONSUMPTION_BREAKDOWN](
  ...
  submit(): void {
    this.service.saveSubtask({
      ...
      currentStep: CurrentStep.ORGANISATIONAL_ENERGY_CONSUMPTION_BREAKDOWN,
      route: this.route,
