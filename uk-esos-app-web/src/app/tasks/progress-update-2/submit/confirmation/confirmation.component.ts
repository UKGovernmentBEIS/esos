...
@Component({
  ...
  template: `
    ...
    <ng-template #whatHappensNextTemplate>
      ...
      <p class="govuk-body">
        Progress Update 2 has been sent to {{ competentAuthorityName() }}.
        <a govukLink [routerLink]="['/contact-us']">Contact your regulator</a>
        if you need to make any updates to Progress Update 2.
      </p>
    </ng-template>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProgressUpdate2SubmitConfirmationComponent {
