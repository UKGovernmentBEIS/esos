...
import { getIntegerValidators } from '../pu2-energy-efficiency-measures.helper';
...
export const newMeasureFormProvider = {
  ...
  useFactory: (fb: FormBuilder, store: RequestTaskStore, route: ActivatedRoute) => {
    ...
    const measure = measureIndex ? store.select(progressUpdate2Query.selectAddedMeasures)()?.[+measureIndex] : null;
    ...
    return fb.group({
      ...
      reductionEnergyConsumption2025To2026: [
        measure?.reductionEnergyConsumption2025To2026 ?? null,
