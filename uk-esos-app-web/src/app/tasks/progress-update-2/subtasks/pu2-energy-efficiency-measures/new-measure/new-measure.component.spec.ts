...
import { mockProgressUpdate2P3AddedMeasure2 } from '@tasks/progress-update-2/testing/mock-data';
import { ActivatedRouteStub, BasePage } from '@testing';
import produce from 'immer';

import { ProgressUpdate2P3AddedMeasure, RequestTaskItemDTO } from 'esos-api';
...
describe('NewMeasureComponent', () => {
  ...
  class Page extends BasePage<NewMeasureComponent> {
    ...
    set reductionEnergyConsumption2025To2026(value: string) {
  ...
  describe('for newly added measure', () => {
    ...
    it('should submit a valid form', () => {
      ...
      page.reductionEnergyConsumption2025To2026 = '111';
      ...
      const expectedAddedMeasure: ProgressUpdate2P3AddedMeasure = {
      ...
      expect(taskServiceSpy).toHaveBeenCalledWith({
        ...
        currentStep: ProgressUpdate2EnergyEfficiencyMeasuresStep.ADD_NEW_MEASURE,
        route: route,
        payload: {
          progressUpdate2P3: {
            progressUpdate2P3MeasuresUpdate: {
              progressUpdate2P3Measures: [],
              progressUpdate2P3AddedMeasure: [expectedAddedMeasure],
            },
          },
        },
  ...
  describe('for existing added measure', () => {
    beforeEach(() => {
      ...
      payload = {
        progressUpdate2P3: {
          progressUpdate2P3MeasuresUpdate: {
            progressUpdate2P3Measures: [],
            progressUpdate2P3AddedMeasure: [mockProgressUpdate2P3AddedMeasure2],
          },
        },
      };
      createComponent();
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.measureName).toEqual(mockProgressUpdate2P3AddedMeasure2.measureName);
      expect(page.measureScheme).toEqual(mockProgressUpdate2P3AddedMeasure2.measureScheme);
      expect(page.otherMeasureSchemeName).toEqual(mockProgressUpdate2P3AddedMeasure2.otherMeasureSchemeName);
      expect(page.estimationMethodType).toEqual(mockProgressUpdate2P3AddedMeasure2.estimationMethodType);
      expect(page.estimationMethodDescription).toEqual(
        mockProgressUpdate2P3AddedMeasure2.estimationMethodDescription ?? '',
      );
      expect(page.measureContext).toEqual(mockProgressUpdate2P3AddedMeasure2.measureContext ?? '');
    ...
    it('should submit a valid unchanged form', () => {
      ...
      expect(taskServiceSpy).toHaveBeenCalledWith({
        subtask: PU2_ENERGY_EFFICIENCY_MEASURES_SUBTASK_NAME,
        currentStep: ProgressUpdate2EnergyEfficiencyMeasuresStep.EDIT_NEW_MEASURE,
        route: route,
        payload,
        applySideEffects: true,
      });
    ...
    it('should submit a valid changed form', () => {
      ...
      page.reductionEnergyConsumption2025To2026 = '112';
      ...
      const expectedChangedMeasure: ProgressUpdate2P3AddedMeasure = {
        ...payload.progressUpdate2P3.progressUpdate2P3MeasuresUpdate.progressUpdate2P3AddedMeasure[0],
        measureName: 'New measure name',
        reductionEnergyConsumption2025To2026: 112,
      ...
      expect(taskServiceSpy).toHaveBeenCalledWith({
        ...
        payload: produce(payload, (_payload) => {
          _payload.progressUpdate2P3.progressUpdate2P3MeasuresUpdate.progressUpdate2P3AddedMeasure[0] =
