...
@Component({
  ...
  template: `
    ...
    <ng-template #whatHappensNextTemplate>
      ...
      <p class="govuk-body">
        The action plan has been sent to {{ competentAuthorityName() }}.
        <a govukLink [routerLink]="['/contact-us']">Contact your regulator</a>
        if you need to make any updates to the action plan.
      </p>
    </ng-template>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ActionPlanSubmitConfirmationComponent {
