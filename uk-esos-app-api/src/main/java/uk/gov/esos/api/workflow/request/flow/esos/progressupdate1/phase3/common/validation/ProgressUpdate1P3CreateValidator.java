...
@Service
public class ProgressUpdate1P3CreateValidator extends RequestCreateAccountRelatedValidator {
    ...
    public ProgressUpdate1P3CreateValidator(final RequestCreateValidatorService requestCreateValidatorService,
    ...
    public RequestCreateValidationResult validateAction(final Long accountId) {
        ...
        if(validationResult.isValid()) {
            ...
            if (!workFlowValidPeriodService.isValidStartDate(RequestType.PROGRESS_UPDATE_1_P3)) {
                return RequestCreateValidationResult.builder()
                        .valid(false)
                        .build();
            }
