...
public class ProgressUpdate1P3ReInitiateSubmitApplicationCreateActionHandler  implements RequestCreateActionHandler<ReportRelatedRequestCreateActionPayload> {
    ...
    public String process(Long accountId, RequestCreateActionType type, ReportRelatedRequestCreateActionPayload payload, AppUser appUser) {
        ...
        requestService.addActionToRequest(
                request,
                null,
                RequestActionType.PROGRESS_UPDATE_1_P3_APPLICATION_RE_INITIATED,
                appUser.getUserId());
