...
public class ActionPlanP3ReInitiateSubmitApplicationCreateActionHandler  implements RequestCreateActionHandler<ReportRelatedRequestCreateActionPayload> {
    ...
    public String process(Long accountId, RequestCreateActionType type, ReportRelatedRequestCreateActionPayload payload, AppUser appUser) {
        ...
        requestService.addActionToRequest(
                request,
                null,
                RequestActionType.ACTION_PLAN_P3_APPLICATION_RE_INITIATED,
                appUser.getUserId());
