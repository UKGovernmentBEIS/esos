package uk.gov.esos.api.workflow.request.flow.esos.progressupdate1.phase3.submit.handler;
...
public class ProgressUpdate1P3ApplicationSubmitActionHandler  implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {

    private final RequestTaskService requestTaskService;
    private final ProgressUpdate1P3SubmitService puSubmitService;
    ...
    public void process(Long requestTaskId, RequestTaskActionType requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        puSubmitService.submitProgressUpdate1Action(requestTask);
        ...
        workflowService.completeTask(requestTask.getProcessTaskId(),
                Map.of(BpmnProcessConstants.REQUEST_ID, requestTask.getRequest().getId(),
                        BpmnProcessConstants.PROGRESS_UPDATE_1_OUTCOME, SUBMIT));
    }

    @Override
    public List<RequestTaskActionType> getTypes() {
        return List.of(RequestTaskActionType.PROGRESS_UPDATE_1_P3_SUBMIT_APPLICATION);
    }
}
