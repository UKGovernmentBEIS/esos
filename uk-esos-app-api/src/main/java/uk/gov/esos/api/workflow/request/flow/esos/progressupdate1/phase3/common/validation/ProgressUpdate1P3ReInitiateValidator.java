...
import uk.gov.esos.api.workflow.request.flow.esos.progressupdate1.common.validation.RequestCreateProgressUpdate1RelatedValidator;

import java.util.Set;

@Service
public class ProgressUpdate1P3ReInitiateValidator extends RequestCreateProgressUpdate1RelatedValidator {


    public ProgressUpdate1P3ReInitiateValidator(final RequestCreateValidatorService requestCreateValidatorService,
    ...
    protected RequestCreateRequestTypeValidationResult validateRequestType(Long accountId, RequestDetailsDTO requestDetailsDTO) {
        ...
        if(requestQueryService.existsRequestByAccountAndTypeAndStatus(accountId, RequestType.PROGRESS_UPDATE_2_P3, RequestStatus.COMPLETED) ||
                requestQueryService.existsRequestByAccountAndTypeAndStatus(accountId, RequestType.PROGRESS_UPDATE_2_P3, RequestStatus.IN_PROGRESS)){
            result.setValid(false);
    ...
    protected RequestType getReferableRequestType() {
        return RequestType.PROGRESS_UPDATE_1_P3;
    }

    @Override
    public RequestCreateActionType getType() {
        return RequestCreateActionType.RE_INITIATE_PROGRESS_UPDATE_1_P3;
    }
}
