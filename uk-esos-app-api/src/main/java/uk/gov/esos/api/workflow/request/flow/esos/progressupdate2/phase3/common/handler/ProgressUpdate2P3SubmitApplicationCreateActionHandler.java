...
public class ProgressUpdate2P3SubmitApplicationCreateActionHandler implements RequestCreateActionHandler<ProgressUpdate2RequestCreateActionPayload> {

    private final StartProcessRequestService startProcessRequestService;

    @Override
    public String process(Long accountId, RequestCreateActionType type, ProgressUpdate2RequestCreateActionPayload payload, AppUser appUser) {
