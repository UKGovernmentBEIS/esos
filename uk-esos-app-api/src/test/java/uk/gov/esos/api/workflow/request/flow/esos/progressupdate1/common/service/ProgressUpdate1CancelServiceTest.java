...
class ProgressUpdate1CancelServiceTest {

    @InjectMocks
    private ProgressUpdate1CancelService service;

    @Mock
    private RequestService requestService;

    @Test
    void cancelProgressUpdate1(){
        ...
        verify(requestService, times(1)).addActionToRequest(
                eq(request),
                eq(null),
                eq(RequestActionType.PROGRESS_UPDATE_1_APPLICATION_CANCELLED),
                eq(request.getPayload().getOperatorAssignee()));
    }
