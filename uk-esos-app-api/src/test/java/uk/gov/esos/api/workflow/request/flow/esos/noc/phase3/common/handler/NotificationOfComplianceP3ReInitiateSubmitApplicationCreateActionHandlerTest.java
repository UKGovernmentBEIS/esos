...
class NotificationOfComplianceP3ReInitiateSubmitApplicationCreateActionHandlerTest {

    @InjectMocks
    private NotificationOfComplianceP3ReInitiateSubmitApplicationCreateActionHandler handler;
    ...
    void process() {
        ...
        verify(requestService, times(1))
                .addActionToRequest(request, null, RequestActionType.NOTIFICATION_OF_COMPLIANCE_P3_APPLICATION_RE_INITIATED, userId);
    }

    @Test
    void getType() {
        assertThat(handler.getType()).isEqualTo(RequestCreateActionType.RE_INITIATE_NOTIFICATION_OF_COMPLIANCE_P3);
    }
}
