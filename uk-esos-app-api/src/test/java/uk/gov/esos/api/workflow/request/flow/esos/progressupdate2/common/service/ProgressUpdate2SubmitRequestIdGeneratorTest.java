...
class ProgressUpdate2SubmitRequestIdGeneratorTest {

    @InjectMocks
    private ProgressUpdate2SubmitRequestIdGenerator generator;
    ...
    void generate() {
        ...
        assertThat(requestId).isEqualTo("PU2007903-P3");
    }

    @Test
    void getTypes() {
        assertThat(generator.getTypes()).containsExactly(RequestType.PROGRESS_UPDATE_2_P3);
    }

    @Test
    void getPrefix() {
        assertThat(generator.getPrefix()).isEqualTo("PU2");
    }
