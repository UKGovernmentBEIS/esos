...
class ProgressUpdate1P3ApplicationSubmitActionHandlerTest {

    @InjectMocks
    private ProgressUpdate1P3ApplicationSubmitActionHandler submitActionHandler;

    @Mock
    private RequestTaskService requestTaskService;

    @Mock
    private ProgressUpdate1P3SubmitService submitService;
    ...
    void process() {
        ...
        verify(submitService, times(1)).submitProgressUpdate1Action(requestTask);
