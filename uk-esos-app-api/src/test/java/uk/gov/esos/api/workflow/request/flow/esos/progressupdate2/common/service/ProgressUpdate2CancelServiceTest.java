...
class ProgressUpdate2CancelServiceTest {

    @InjectMocks
    private ProgressUpdate2CancelService service;

    @Mock
    private RequestService requestService;

    @Test
    void cancelProgressUpdate2(){
        ...
        verify(requestService, times(1)).addActionToRequest(
                eq(request),
                eq(null),
                eq(RequestActionType.PROGRESS_UPDATE_2_APPLICATION_CANCELLED),
