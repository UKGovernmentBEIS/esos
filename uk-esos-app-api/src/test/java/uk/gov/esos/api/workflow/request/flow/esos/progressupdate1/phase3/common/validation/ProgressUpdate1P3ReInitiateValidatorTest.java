...
class ProgressUpdate1P3ReInitiateValidatorTest {

    @InjectMocks
    private ProgressUpdate1P3ReInitiateValidator validator;
    ...
    @Test
    void getType() {
        assertThat(validator.getType()).isEqualTo(RequestCreateActionType.RE_INITIATE_PROGRESS_UPDATE_1_P3);
    }
    ...
    void validateAction() {
        ...
        final RequestDetailsDTO requestDetailsDTO = new RequestDetailsDTO(requestId, RequestType.PROGRESS_UPDATE_1_P3,
                RequestStatus.COMPLETED, LocalDateTime.now(), ProgressUpdate1P3RequestMetadata.builder().build());

        when(requestQueryService.findRequestDetailsByIdAndAccountId(requestId, accountId)).thenReturn(requestDetailsDTO);
        when(accountAuthorizationResourceService.hasUserScopeToAccountAndResourceSubType(appUser, accountId, Scope.REQUEST_CREATE, RequestCreateActionType.RE_INITIATE_PROGRESS_UPDATE_1_P3.name()))
                .thenReturn(true);
        ...
        verify(accountAuthorizationResourceService, times(1))
                .hasUserScopeToAccountAndResourceSubType(appUser, accountId, Scope.REQUEST_CREATE, RequestCreateActionType.RE_INITIATE_PROGRESS_UPDATE_1_P3.name());
    ...
    void validateRequestType() {
        final Long accountId = 1L;
        final RequestDetailsDTO requestDetailsDTO = new RequestDetailsDTO("PU1000001-P3", RequestType.PROGRESS_UPDATE_1_P3,
                RequestStatus.COMPLETED, LocalDateTime.now(), ProgressUpdate1P3RequestMetadata.builder().build());

        when(requestQueryService.existsRequestByAccountAndTypeAndStatus(accountId, RequestType.PROGRESS_UPDATE_2_P3, RequestStatus.COMPLETED)).thenReturn(false);
    ...
    @Test
    void validateRequestType_In_progress_not_valid() {
        final Long accountId = 1L;
        final RequestDetailsDTO requestDetailsDTO = new RequestDetailsDTO("PU1000001-P3", RequestType.PROGRESS_UPDATE_1_P3,
                RequestStatus.IN_PROGRESS, LocalDateTime.now(), ProgressUpdate1P3RequestMetadata.builder().build());
    ...
    @Test
    void validateRequestType_progressUpdate_exist_not_valid() {
        final Long accountId = 1L;
        final RequestDetailsDTO requestDetailsDTO = new RequestDetailsDTO("PU100001-P3", RequestType.PROGRESS_UPDATE_1_P3,
                RequestStatus.COMPLETED, LocalDateTime.now(), ProgressUpdate1P3RequestMetadata.builder().build());

        when(requestQueryService.existsRequestByAccountAndTypeAndStatus(accountId, RequestType.PROGRESS_UPDATE_2_P3, RequestStatus.COMPLETED)).thenReturn(true);
    ...
    void getReferableRequestType() {
        assertThat(validator.getReferableRequestType()).isEqualTo(RequestType.PROGRESS_UPDATE_1_P3);
    }
