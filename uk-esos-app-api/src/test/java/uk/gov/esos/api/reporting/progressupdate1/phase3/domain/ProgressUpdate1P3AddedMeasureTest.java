...
class ProgressUpdate1P3AddedMeasureTest {
    ...
    void shouldPassValidationWhenEstimationMethodTypeOtherWithDescription() {
        ...
        Set<ConstraintViolation<ProgressUpdate1P3AddedMeasure>> violations = validator.validate(measure);
    ...
    void shouldFailValidationWhenEstimationMethodTypeOtherWithoutDescription() {
        ...
        ConstraintViolation<ProgressUpdate1P3AddedMeasure> violation = violations.iterator().next();
