...
class ProgressUpdate2P3ReInitiateSubmitApplicationCreateActionHandlerTest {

    @InjectMocks
    private ProgressUpdate2P3ReInitiateSubmitApplicationCreateActionHandler handler;
    ...
    void process() {
        ...
        verify(requestService, times(1))
                .addActionToRequest(request, null, RequestActionType.PROGRESS_UPDATE_2_P3_APPLICATION_RE_INITIATED, userId);
    }

    @Test
    void getType() {
        assertThat(handler.getType()).isEqualTo(RequestCreateActionType.RE_INITIATE_PROGRESS_UPDATE_2_P3);
    }
