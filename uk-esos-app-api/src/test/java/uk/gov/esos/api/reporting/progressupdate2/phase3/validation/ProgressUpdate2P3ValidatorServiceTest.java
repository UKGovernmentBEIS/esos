package uk.gov.esos.api.reporting.progressupdate2.phase3.validation;
...
import uk.gov.esos.api.reporting.progressupdate.progressupdate2.phase3.validation.ProgressUpdate2P3ValidatorService;
...
class ProgressUpdate2P3ValidatorServiceTest {
    ...
    @InjectMocks
    private ProgressUpdate2P3ValidatorService service;
    ...
    void testValidate_ValidSubmissionDateAndNoViolations() {
        ...
        // Arrange
        ProgressUpdate2P3Container container = ProgressUpdate2P3Container.builder()
                .progressUpdate2P3(ProgressUpdate2P3.builder().groupChange(GroupChange.builder().otherResponsibleUndertakingCrn("123").build()).build()).build();

        ProgressUpdate2P3AddedMeasure addedMeasure = ProgressUpdate2P3AddedMeasure.builder().measureName("name").build();

        ProgressUpdate2P3MeasuresUpdate measuresUpdate = ProgressUpdate2P3MeasuresUpdate.builder().progressUpdate2P3AddedMeasure(List.of(addedMeasure)).build();

        container.getProgressUpdate2P3().setProgressUpdate2P3MeasuresUpdate(measuresUpdate);
        container.getProgressUpdate2P3().getProgressUpdate2P3MeasuresUpdate().setProgressUpdate2P3AddedMeasure(List.of(addedMeasure));

        when(queryService.getOrganisationAccountDTOById(1L)).thenReturn(dto);

        when(workFlowValidPeriodService.isValidSubmitDate(RequestType.PROGRESS_UPDATE_2_P3)).thenReturn(true);
        ...
        verify(workFlowValidPeriodService, times(1)).isValidSubmitDate(RequestType.PROGRESS_UPDATE_2_P3);
        verify(validator, times(1)).validate(container);
    }

    @Test
    void testValidate_InvalidSubmissionDate() {
        ProgressUpdate2P3Container container = mock(ProgressUpdate2P3Container.class);

        when(workFlowValidPeriodService.isValidSubmitDate(RequestType.PROGRESS_UPDATE_2_P3)).thenReturn(false);  // Invalid submission date
    ...
    void testValidate_WithValidationErrors() {
        ...
        Set<ConstraintViolation<ProgressUpdate2P3Container>> violations = new HashSet<>();
        ConstraintViolation<ProgressUpdate2P3Container> violation = mock(ConstraintViolation.class);
        ...
        assertThat(exception.getErrorCode()).isEqualTo(ErrorCode.INVALID_PROGRESS_UPDATE_2);
        verify(workFlowValidPeriodService, times(1)).isValidSubmitDate(RequestType.PROGRESS_UPDATE_2_P3);
        verify(validator, times(1)).validate(container);
    }
    ...
    void testValidate_ValidGroupChangeOrgName() {
        ...
        // Arrange
        ProgressUpdate2P3Container container = ProgressUpdate2P3Container.builder()
                .progressUpdate2P3(ProgressUpdate2P3.builder().groupChange(GroupChange.builder().otherResponsibleUndertakingName("other name").build()).build()).build();
    ...
    void testValidate_In_ValidGroupChangeOrgName() {
        ProgressUpdate2P3Container container = ProgressUpdate2P3Container.builder()
                .progressUpdate2P3(ProgressUpdate2P3.builder().groupChange(GroupChange.builder().otherResponsibleUndertakingName("org").build()).build()).build();
