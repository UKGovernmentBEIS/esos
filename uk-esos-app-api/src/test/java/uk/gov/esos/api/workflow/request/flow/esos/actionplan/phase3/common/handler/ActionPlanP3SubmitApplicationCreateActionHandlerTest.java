...
class ActionPlanP3SubmitApplicationCreateActionHandlerTest {

    @InjectMocks
    private ActionPlanP3SubmitApplicationCreateActionHandler handler;
    ...
    @Test
    void getType() {
        assertThat(handler.getType()).isEqualTo(RequestCreateActionType.ACTION_PLAN_P3);
    }
